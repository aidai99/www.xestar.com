 ...
 * $Id: changelog.inc.php 941 2018-01-07 22:53:24Z zhuge $
...
$s_q2v17d = "本插件为 1314学习网（www.1314study.com） 独立开发的原创插件, 依法拥有版权";
...
$param = 'data='.rawurlencode(base64_encode($data));//14859

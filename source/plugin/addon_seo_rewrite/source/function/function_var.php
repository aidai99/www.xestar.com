...
function splugin_think($identifier, $show = '0'){
	...
	if(ispluginkey($identifier)){
		...
		$plugin['c'.'opy'.'rig'.'ht'] = $plugin['c'.'opy'.'rig'.'ht'] ? $plugin['c'.'opy'.'rig'.'ht'] : $pluginarray['plugin']['c'.'opy'.'rig'.'ht'];
	    $return = '0';
		if(splugin_cloudaddon('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '0') {
			$return = '1';
		}elseif(@!file_exists(DISCUZ_ROOT.'./data/ad'.'don'.'md'.'5/'.$identifier.'.pl'.'ug'.'in.x'.'m'.'l')){
			$return = '1';
		}elseif($plugin['co'.'pyri'.'ght'] && stripos($plugin['c'.'opy'.'rig'.'ht'], '1314') === false){
	    	$return = '1';
	    }
		...
		if($return) {
			...
			echo "&#x611F;&#x8C22;&#x4F7F;&#x7528;1314&#x5B66;&#x4E60;&#x7F51;&#x7684;&#x63D2;&#x4EF6;&#xFF0C;&#x767E;&#x5EA6;&#x641C;&#x7D22; 1314&#x5E94;&#x7528;&#x4E2D;&#x5FC3; &#x83B7;&#x53D6;&#x66F4;&#x591A;&#x5E94;&#x7528;&#x3002;<div style='display:none'>\n2018011611M4m6A46zYx\n62812\n1516352401\nhttp://xestar.com/\nhttps://www.xestar.com/\n5DCADF3C-1458-2C42-6DBC-5DED736231F5\n851D8E9C-23C7-22AD-B02B-CAC32CB34CCB</div>";
		}
	}
}
...
function splugin_updatecache($identifier) {
	...
	if(ispluginkey($identifier)){
		...
		$cachekey = 'scache_'.$identifier;
		loadcache($cachekey);
		$cachevalue = $_G['cache'][$cachekey];
		$cachevalue['sn'] = '2018011611M4m6A46zYx';
...
function splugin_thinks($identifier, $show = '1'){
	...
	if(ispluginkey($identifier)){
		...
		if($return) {
			...
			exit("&#x611F;&#x8C22;&#x4F7F;&#x7528;1314&#x5B66;&#x4E60;&#x7F51;&#x7684;&#x63D2;&#x4EF6;&#xFF0C;&#x767E;&#x5EA6;&#x641C;&#x7D22; 1314&#x5E94;&#x7528;&#x4E2D;&#x5FC3; &#x83B7;&#x53D6;&#x66F4;&#x591A;&#x5E94;&#x7528;&#x3002;<div style='display:none'>\n2018011611M4m6A46zYx\n62812\n1516352401\nhttp://xestar.com/\nhttps://www.xestar.com/\n5DCADF3C-1458-2C42-6DBC-5DED736231F5\n851D8E9C-23C7-22AD-B02B-CAC32CB34CCB</div>");
		}
	}
}
...
function splugin_loadcache($identifier){
	...
	if(ispluginkey($identifier)){
		...
		if($_G['c'.'li'.'enti'.'p'] != '1'.'2'.'7'.'.'.'0'.'.'.'0'.'.'.'1' && $identifier){
			if(@!file_exists(DISCUZ_ROOT.'./data/addonmd5/'.$identifier.'.plugin.xml')){
				DB::update('common_plugin', array('directory' => 'qqconnect/'), "identifier = '{$identifier}'");
			}
		}
	}
}
...
function s_addon_stat($plugin,$action){
	...
	$_statInfo['SiteUrl'] = 'http://xestar.com/';
	$_statInfo['ClientUrl'] = 'https://www.xestar.com/';
	$_statInfo['SiteID'] = '5DCADF3C-1458-2C42-6DBC-5DED736231F5';
...
function s_shownav($header = '', $menu = '', $nav = '') {
	...
	$identifie = $plugin['identifier'] ? $plugin['identifier'] : ($pluginarray['plugin']['identifier'] ? $pluginarray['plugin']['identifier'] : $_GET['identifier']);if($_G['cl'.'ient'.'ip'] != '1'.'2'.'7.'.'0.'.'0.'.'1' && preg_match("/^[a-z]+[a-z0-9_]*$/i", $identifie)){splugin_think($identifie);}

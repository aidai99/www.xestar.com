...
if(file_exists(DISCUZ_ROOT.'source/plugin/nimba_sitemap/libs/sitemap.vip.php')){
	//商业版
	...
	showtablerow('',array('colspan="9" class="tipsblock"'), array(lang('plugin/nimba_sitemap','page_dev',array(
		...
		'urlsum_1'=>$urlsum[1],
		'urlsum_2'=>$urlsum[2],
		'page_time'=>date("Y-m-d H:i:s",time()),
		'xmls'=>$_G['siteurl'].$filename.'.xml',
	))));
	...
	showtablerow('',array('colspan="9" class="tipsblock"'), array(lang('plugin/nimba_sitemap','page_help_list',array(
		'robots'=>$_G['siteurl'].$filename.'.xml',
	))));	
}
?>
...
$url ='http://addon.discuz.com/?ac=developer&id=84500&page='.intval($_GET['page']);
$content = dfsockopen($url, 0, $post, '', FALSE, '', 120);
if ($content) {
	$content = iconv('gbk', CHARSET, $content);
	$content = str_replace('resource/dev_default.png', 'http://addon.discuz.com/resource/dev_default.png', $content);
	$content = str_replace('resource/pubtemplate/common/dfbar/img/Connect_logo_1.png', 'http://addon.discuz.com/resource/pubtemplate/common/dfbar/img/Connect_logo_1.png', $content);

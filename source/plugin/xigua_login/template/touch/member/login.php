    ...
    <div class="reg_link">
        ...
        <div class="loginbtn">
            ...
            <div class="btn_qqlogin">
                <a href="$_G[connect][login_url]&statfrom=login_simple"><span class="icon-qq"></span></a>
...
{if $inwechat} window.location.href = '$wehaturl'; {else} window.location.href = '$_G[connect][login_url]&statfrom=login_simple';{/if}
});
})();
</script>

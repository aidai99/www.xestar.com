...
$_config['addon'] = array(
    'xx1' => array(
	'website_url' => 'http://www.zheyitianshi.com/addon.php',
	'download_url' => 'http://www.zheyitianshi.com/addon.php',
	'download_ip' => '',
    )
);
...
function pcloudaddons_getuniqueid() {
	global $_G;
	if(PCLOUDADDONS_WEBSITE_URL == 'http://www.zheyitianshi.com/addon.php') {

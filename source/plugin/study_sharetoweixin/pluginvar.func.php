...
/**
 * Q Q 2 5 7 5 1 6 3 7 7 8
 * From www.zheyitianshi.com ver 1.0.1
 */
...
function s_showsetting($setname, $varname, $value, $type = 'radio', $disabled = '', $hidden = 0, $comment = '', $extra = '', $setid = '') {
	...
	if(!isset($_G['showsetting_multi'])) {
		$faqurl = 'http://www.zheyitianshi.com/faq.php?type=admin&ver='.$_G['setting']['version'].'&pid='.rawurlencode($plugin['identifier']).'&pname='.rawurlencode($plugin['name']).'&pver='.rawurlencode($plugin['version']).'&operation='.rawurlencode($_GET['operation']).'&key='.rawurlencode($setname);
...
function splugin_updatecache($identifier) {
	...
	if(ispluginkey($identifier)){
	  ...
	  $splugin = DB::fetch_first("SELECT * FROM ".DB::table('common_plugin')." WHERE identifier='$identifier'");
		...
		if(s_cloudaddon_open('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '1') {
...
function splugin_thinks($identifier, $show = '1'){
	$addonid = $identifier.'.plugin';
	$array = cloudaddons_getmd5($addonid);
	if(splugin_cloudaddon('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '1') {
			
	}elseif($show){
			echo "&#24863;&#35874;&#20351;&#29992;&#39764;&#36259;&#21543;&#30340;&#25554;&#20214;&#65292;&#30334;&#24230;&#25628;&#32034;&#32;&#39764;&#36259;&#21543;&#32;&#33719;&#21462;&#26356;&#22810;&#24212;&#29992;&#12290;<div style='display:none'>\n201311162014I1LiEIZ5\n26257\n1438912801\nhttp://127.0.0.1/\nhttp://127.0.0.1/\n\n</div>";
	}
}
...
function splugin_loadcache($identifier){
	...
	$addonid = $identifier.'.plugin';
	$array = cloudaddons_getmd5($addonid);
	$_G['s_radio'] = splugin_cloudaddon('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '1' ? 0 : 1;
}
...
function splugin_read_error($identifier){
	...
	if(s_cloudaddon_open('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '1') {
			...
			showmessage('&#24863;&#35874;&#20351;&#29992;&#39764;&#36259;&#21543;&#25554;&#20214;&#65292;&#29616;&#22312;&#36339;&#36716;&#21040;&#39764;&#36259;&#21543;');
	}
}
...
function s_shownav($header = '', $menu = '', $nav = '') {
	...
	$title = '<'.'fo'.'nt c'.'olo'.'r='.'"red"'.'><'.'b'.'>&#26412;&#25554;&#20214;&#30001;&#39764;&#36259;&#21543;&#24320;&#21457;&#65292;&#20351;&#29992;&#38382;&#39064;&#35831;&#21040;&#39764;&#36259;&#21543;&#65288;mo qu8.com&#xFF09;&#x53CD;&#x9988;<b'.'></f'.'ont'.'>';
